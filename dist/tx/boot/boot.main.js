...
export async function boot(nameProject) {
    ...
    if (manifest.logProject) {
        ...
        console.log("DISTROS=", distros.map((d) => ({ n: d.__distro_name, v: d.__version })));
        console.log("ROUTES=", routesDeclared.map((r) => ({ p: r.path, m: r.method, b: r.base })));
...
//# sourceMappingURL=boot.main.js.map